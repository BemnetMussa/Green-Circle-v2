...
export const alt = 'Green Circle — a curated home for the real startups being built in Ethiopia.';
...
export default async function OpengraphImage() {
  ...
  return new ImageResponse(
    (
      ...
      >
        <div style={{ position: 'absolute', right: -120, top: -80, opacity: 0.08 }}>
          <svg viewBox="0 0 100 100" width={620} height={620}>
            <path
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
          ...
          >
            A curated home for the real startups being built in Ethiopia.
          </div>
          <div
            style={{
              display: 'flex',
